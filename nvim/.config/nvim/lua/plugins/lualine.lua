        ...
        lualine_x = {
          {
            ...
            cond = function()
              return vim.fn.winwidth(0) > 100 -- Show diagnostics only if the window width is greater than 100
            end,
          },
          {
            ...
            cond = function()
              return vim.fn.winwidth(0) > 100 -- Show diff only if the window width is greater than 100
            end,
          },
          {
            'encoding',
