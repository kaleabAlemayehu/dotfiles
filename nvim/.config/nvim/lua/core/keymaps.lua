...
-- To center view during scroll and searching
...
-- Enable To enforce bad habit of too many <Esc>
vim.keymap.set('n', '<Esc><Esc>', '<cmd>echo "Chill Man!! Don\'t You Need Your Pinky?!!"<CR>')
...
vim.keymap.set('n', '<leader>x', ':bdelete!<CR>', { desc = '[B]uffer [D]elete' }) -- close buffer
